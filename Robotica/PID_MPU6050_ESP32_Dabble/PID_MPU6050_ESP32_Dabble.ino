...
float KpLeft = 3.0, KiLeft = 0.1, KdLeft = 1.5;  // Constantes ajustadas para melhorar a roda esquerda
float prevErrorYawLeft = 0;
float integralYawLeft = 0;

// Constantes PID ajustadas para a roda direita
float KpRight = 3.0, KiRight = 0.1, KdRight = 1.5;  // Constantes ajustadas para a roda direita
